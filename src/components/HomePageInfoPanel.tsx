...
const HomePageInfoPanel = () => {
  ...
  return (
    <div className="home-page font-sans pt-50">
      <div
      ...
      <div className="pt-8 px-8 ">
        ...
        <p className="text-center text-lg mt-2 mb-8">
          Track your nutrients accurately, count calories on any diet, and find
          your personalized nutritious recipes ready to use in one go.
        </p>
